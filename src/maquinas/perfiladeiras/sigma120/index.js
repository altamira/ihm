...
export default class IHM extends Component {
	...
	handleMenuPrincipal() {
		this.props.router.push('/maquinas/perfiladeiras/sigma120/main');
	}

	handleTarefas() {
		this.props.router.push('/maquinas/perfiladeiras/sigma120/tarefas');
	}
	
	handleManual(params) {
		this.props.router.push('/maquinas/perfiladeiras/sigma120/manual');
	}

	handleRelatorios(params) {
		this.props.router.push('/maquinas/perfiladeiras/sigma120/relatorios');
	}

	handleProgramacao(params) {
		this.props.router.push('/maquinas/perfiladeiras/sigma120/programacao');
	}

	handleManutencao(params) {
		this.props.router.push('/maquinas/perfiladeiras/sigma120/manutencao');
	}
	/*handlePerfil(perfil){
