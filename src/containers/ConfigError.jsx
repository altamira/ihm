...
export default class ConfigError extends Component {
	constructor(props) {
		super(props);
			...
			<div className="static-modal">
		        <Modal.Dialog>
		          ...
		          <Modal.Body>
		          	...
		          	<h4 style={{textAlign: 'center'}}>Erro ao carregar configurações da máquina. Verifique node-red, mongoDB e a conexão de rede.</h4>
		          ...
		          <Modal.Footer>
		            ...
		            >
		            	Tentar novamente {!!this.state.tryCount && '(' + this.state.tryCount + ')'}
		            </Button>
		          </Modal.Footer>
